    ...
    return (
        <section className="relative w-full max-w-7xl mx-auto px-4 py-12 md:py-[70px] flex flex-col lg:flex-row gap-8 lg:gap-6 items-center">
            ...
            <div className="flex-1 flex flex-col gap-5 items-start justify-center">
                ...
                {/* Heading */}
                <h1 className="font-headings font-normal text-4xl md:text-[46px] leading-[1.1] text-carbon-black capitalize">
                ...
                <div className="flex flex-wrap gap-2 items-start w-full">
                    {FEATURES.map((feature, i) => (
                        <div
                            key={i}
                            className="flex items-center gap-2 bg-white border border-[#0E3572]/40 rounded-full px-3 py-1.5 shrink-0"
                        >
            ...
            <div className="flex items-center justify-center w-full lg:w-auto shrink-0">
                ...
                >
                    {/* Form Title */}
                    <p className="font-headings font-normal text-2xl text-regal-navy text-center w-full">
