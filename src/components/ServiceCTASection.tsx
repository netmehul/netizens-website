        ...
        <section className="relative w-full bg-regal-navy flex flex-col items-center py-20 overflow-hidden">
            ...
            <div className="w-full max-w-4xl mx-auto px-4 relative z-10 flex flex-col items-center justify-center text-center gap-8">
                <div className="flex flex-col gap-4 items-center">
                    <h2 className="font-headings font-normal text-[32px] sm:text-[40px] md:text-[46px] leading-tight text-snow-white">
                        {heading}
                    </h2>
                    <p className="font-sans font-medium text-sm sm:text-base leading-relaxed text-snow-white/90 max-w-lg">
                        {description}
                    </p>
                </div>
