    ...
    return (
        <section ref={sectionRef} className="relative w-full bg-white py-20 md:py-14 overflow-hidden">
            <div className="w-full max-w-8xl mx-auto px-4 md:px-4 ">
                {/* Header */}
                <div ref={headerRef} className="flex flex-col items-center gap-4 text-center mb-16 md:mb-24">
                    <div className="flex items-center justify-center px-4 py-2 bg-white/90 border border-gray-200 rounded-lg">
                        <span className="font-sans text-xs font-semibold text-charcoal uppercase tracking-wide">
                            Our Promise
                        </span>
                    </div>
                    <h2 className="font-headings font-normal text-2xl md:text-[34px] leading-tight text-carbon-black max-w-4xl">
                        Different engagement models. Same standard.
                    </h2>
                </div>

                {/* Main layout: 4 cards + center with connector lines */}
                <div className="relative grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-8 md:gap-34 items-center max-w-6xl mx-auto ">
                    ...
                    <div className="relative z-10 flex flex-col gap-6 md:gap-8 order-2 md:order-1">
                        {PROMISE_CARDS.slice(0, 2).map((card, i) => (
                            <div
                                ...
                                className="bg-white border border-regal-navy/15 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300"
                            >
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-sans text-sm text-charcoal leading-[22px]">
                                            {card.description}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div
                        ref={centerRef}
                        className="relative z-10 flex items-center justify-center order-1 md:order-2 my-8 md:my-0"
                    >
                        <div
