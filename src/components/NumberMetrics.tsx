...
export const NumberMetrics = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1360px] mx-auto flex flex-col items-center justify-center py-8 sm:py-14 md:py-20 px-6 md:px-8 relative z-10 w-full">
        {/* Header Subtitle & Title */}
        <div
          ref={headerRef}
          className="flex flex-col items-center gap-2 mb-6 sm:mb-10 w-full max-w-3xl text-center"
        >
          <span className="font-['Plus_Jakarta_Sans',sans-serif] font-normal text-[12px] text-[#FFFAFA] bg-[rgba(255,250,250,0.1)] border border-[rgba(14,53,114,0.1)] px-[18px] py-[8px] rounded-[4px] tracking-wide">
            Numbers Speaks
          </span>
          <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-2xl sm:text-[36px] md:text-[48px] text-white leading-tight">
            Built for ROI, Not Just Design
          </h2>
        </div>

        {/* Metrics Grid */}
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1.5">
            ...
            >
              ...
              <div className="flex flex-col gap-2 sm:gap-[4px] items-start w-full relative z-10">
                <h3
                  ...
                  className="font-['Geist_Mono',monospace] font-medium text-2xl sm:text-[36px] md:text-[40px] text-white leading-none tracking-tight"
                >
                  0
                </h3>
                <p className="font-['Geist_Mono',monospace] font-medium text-[16px] text-white/90 leading-snug">
                  {metric.unit}
                </p>
              </div>

              <p className="font-['Plus_Jakarta_Sans',sans-serif] font-medium text-[12px] md:text-[14px] text-white/80 sm:leading-[24px] relative z-10">
                {metric.description}
              </p>
            </div>
          ))}
