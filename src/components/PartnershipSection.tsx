        ...
        >
            ...
            <div className="relative z-10 max-w-[1320px] mx-auto px-4 md:px-6">
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-6 items-center">
                    {/* Left Column */}
                    <div ref={leftColRef} className="flex flex-col gap-8 w-full lg:w-[648px] shrink-0">
                        {/* Heading group */}
                        <div className="flex flex-col gap-3">
                            ...
                            <h2 className="font-headings font-normal text-[26px] md:text-[30px] leading-normal text-[#FFFAFA]">
                    ...
                    <div ref={rightColRef} className="flex-1 w-full lg:w-auto flex items-center justify-center lg:justify-end">
                            ...
                            <div className="flex flex-col gap-3">
                                {LABEL_ITEMS.map((label, i) => (
                                    ...
                                    >
                                        ...
                                        <span className="font-sans font-medium text-base leading-[22px] text-[#58595B]">{label}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="hidden lg:block relative" style={{ width: 591, height: 430 }}>
                            ...
                            <div
                                ...
                                style={{ left: 0, top: '50%', transform: 'translateY(-50%)', width: 200, height: 200, boxShadow: '0 0 40px rgba(62,175,209,0.15), 0 0 80px rgba(14,53,114,0.3)' }}
                            >
                                <img src={partnershipCenterImg} alt="Partnership" className="w-full h-full object-cover" />
                            </div>
                            ...
                            {LABEL_ITEMS.map((label, i) => (
                                <div
                                    key={i}
                                    ref={(el) => { labelRefs.current[i] = el; }}
                                    className="absolute bg-white border border-[rgba(88,89,91,0.1)] rounded-[6px] p-[18px] flex items-center gap-2 hover:shadow-md transition-shadow duration-300"
                                    style={{ left: 298, top: i * 74, width: 293, height: 60 }}
                                >
                                    <div className="shrink-0">{CHECK_ICON}</div>
                                    <span className="font-sans font-medium text-base leading-[22px] text-[#58595B]">{label}</span>
                                </div>
