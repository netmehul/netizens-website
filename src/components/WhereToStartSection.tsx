        ...
        >
            ...
            <div className="relative z-10 max-w-[1320px] mx-auto px-4 md:px-6">
                <div className="flex flex-col lg:flex-row gap-6 items-stretch">
                    ...
                    <div
                        ref={ctaRef}
                        className="bg-white rounded-[10px] p-[18px] flex flex-col gap-[18px] w-full lg:w-[312px] lg:min-h-[320px] shrink-0"
                    >
                    ...
                    {DELIVERY_CARDS.map((card, i) => (
                        <div
                            ...
                            className="bg-[rgba(255,250,250,0.1)] border border-[rgba(255,250,250,0.75)] rounded-[10px] p-[18px] flex flex-col gap-[10px] w-full lg:w-[312px] lg:min-h-[320px] shrink-0 group hover:bg-[rgba(255,250,250,0.15)] transition-colors duration-300"
                        >
