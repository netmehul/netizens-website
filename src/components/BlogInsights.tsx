            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-[112px]">
                ...
                <div className="flex items-end justify-between mb-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <h2 className="font-['Sora'] font-normal text-[24px] lg:text-[30px] text-[#16181b] leading-normal">
                ...
                {/* Accordion slider */}
                <div className="flex gap-[17px] items-center w-full h-[300px] md:h-[430px]">
                ...
                `}
                            ...
                            >
                                {/* Gray placeholder with subtle inner content */}
                                <div className="absolute inset-0 flex items-end p-4">
                                    {isActive && (
                                        <div className="bg-black/20 backdrop-blur-sm rounded px-3 py-2 transition-opacity duration-300">
                                            <span className="text-white/70 text-xs font-['Plus_Jakarta_Sans']">
                                                Blog Post {index + 1}
                                            </span>
                                        </div>
                                    )}
