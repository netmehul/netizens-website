        ...
        <section className="relative w-full bg-white py-16 md:py-20 overflow-hidden">
            ...
            <div className="max-w-[1200px] mx-auto px-4 flex flex-col items-center gap-8 md:gap-10 relative z-10">
                ...
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <h2 className="font-headings font-normal text-2xl md:text-[30px] leading-snug text-carbon-black">
                        {heading}
                    </h2>
                </div>
                    ...
                    <div className="relative flex flex-col items-center">
                        ...
                        <div className="relative w-[200px] h-[240px] flex items-center justify-center">
                            ...
                            <div className="relative flex flex-col items-center gap-2 px-4 -mt-7">
                                ...
                                <h3 className="font-headings font-normal text-base text-snow-white text-center leading-snug">
                                    {centerTitle}
                                </h3>
                                <p className="font-sans font-medium text-xs text-snow-white/75 text-center leading-relaxed">
                                    {centerDescription}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="relative flex flex-col items-center shrink-0 mx-[-40px]">
                        ...
                        <div className="relative w-[250px] h-[300px] flex items-center justify-center">
                            ...
                            <div className="relative flex flex-col items-center gap-3 px-4 -mt-10">
                                ...
                                <h3 className="font-headings font-normal text-lg text-snow-white text-center leading-[25px]">
                                    {centerTitle}
                                </h3>
                                <p className="font-sans font-medium text-sm text-snow-white/75 text-center leading-[22px]">
                                    {centerDescription}
                                </p>
                            </div>
                        </div>
