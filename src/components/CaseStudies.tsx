...
export const CaseStudies = () => {
  ...
  return (
    <section className="relative w-full py-8 sm:py-12 md:py-20 bg-[#FDFDFD] overflow-hidden px-4 md:px-8 flex items-center justify-center">
      <SidePattern invert />
      ...
      <div className="max-w-[1320px] mx-auto flex flex-col items-center gap-4 sm:gap-[34px] relative z-10 w-full font-['Plus_Jakarta_Sans',sans-serif]">
        {/* Heading Wrapper */}
        <div className="w-full max-w-[1096px] flex flex-col md:flex-row gap-[16px] items-center justify-between">
          <h2 className="font-['Sora',sans-serif] font-normal text-2xl md:text-[30px] text-[#16181B]">
              ...
              >
                <div className="w-full backdrop-blur-[2px] bg-white border border-[rgba(88,89,91,0.1)] rounded-[10px] p-[24px] md:p-[34px] flex flex-col md:flex-row gap-4 sm:gap-[34px] md:gap-[18px] items-start shadow-sm hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="flex-1 flex flex-col justify-center items-start gap-3 sm:gap-[18px]">
                    <h3 className="font-['Sora',sans-serif] font-bold text-[24px] text-[#16181B]">
                      {slide.company}
                    </h3>
                    <p className="font-['Plus_Jakarta_Sans',sans-serif] font-normal text-sm md:text-[18px] text-[#16181B] leading-[1.6] md:leading-[32px]">
                      {slide.description}
                    </p>

                    <div className="flex flex-col items-start gap-[8px] py-[8px]">
                      <span className="font-['Sora',sans-serif] font-normal text-[26px] md:text-[30px] text-[#16181B]">
                        {slide.metric}
                      </span>
                  ...
                  <div className="w-full md:max-w-[300px] lg:max-w-[400px] flex flex-col gap-[16px] shrink-0">
                    ...
                    <div className="flex flex-col gap-[4px] px-1">
                      <h4 className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[16px] text-[#0E3572]">
                        {slide.authorName}
                      </h4>
                      <p className="font-['Plus_Jakarta_Sans',sans-serif] font-normal text-[12px] text-[#16181B]">
                        {slide.authorTitle}
                      </p>
                    </div>
                  </div>
