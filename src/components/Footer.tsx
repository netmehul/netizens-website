    ...
    return (
        <footer className="w-full flex flex-col font-sans">
            ...
            <div className="w-full bg-white flex flex-col items-center py-10 md:py-16 px-4 md:px-8">
                <div className="w-full max-w-[1320px] mx-auto flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-8">

                    {/* Left: Branding & Newsletter */}
                    <div className="flex flex-col gap-8 w-full lg:w-auto max-w-sm">
                        <div className="h-[82px] w-[276px] overflow-hidden">
                            <Logo className="w-full h-auto max-h-[82px] object-contain object-left" />
                        </div>
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <div className="border-b border-charcoal/40 flex items-center justify-between py-1.5 w-full transition-colors focus-within:border-regal-navy">
                                <input
                                    ...
                                    className="bg-transparent border-none outline-none font-sans font-medium text-sm text-carbon-black/80 placeholder:text-charcoal/40 flex-1 w-full"
                                />
                    ...
                    {/* Middle: Links Grid */}
                    <div className="flex flex-col sm:flex-row gap-12 sm:gap-24 lg:gap-16 w-full lg:w-auto">
                        <div className="flex flex-col gap-4">
                            <h4 className="font-sans font-bold text-sm text-[#0e3572]">Services</h4>
