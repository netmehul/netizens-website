        ...
        >
            ...
            <div className="w-full max-w-[1096px] mx-auto px-4 relative z-10 flex flex-col items-center gap-10">
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <h2 className="font-headings font-normal text-3xl md:text-[38px] leading-snug text-snow-white">
                        Build. Run. Scale.
                    </h2>
                </div>
                        ...
                        >
                            <div className="flex flex-col sm:flex-row h-full">
                                <div className="flex-shrink-0 flex flex-col justify-center gap-3 p-6 sm:p-10 md:p-12 sm:w-[40%]">
                                    ...
                                    <p className="font-sans font-medium text-sm md:text-base text-charcoal/75 leading-[22px] max-w-[360px]">
                                        {card.description}
                                    </p>
                                </div>
