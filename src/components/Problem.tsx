...
import problemIcon1 from "../assets/images/problem-icon/problem 1 - icon.svg";
import problemIcon2 from "../assets/images/problem-icon/problem 2 - icon.svg";
import problemIcon3 from "../assets/images/problem-icon/problem 3 - icon.svg";
import problemIcon4 from "../assets/images/problem-icon/problem 4 - icon.svg";
import problemIcon5 from "../assets/images/problem-icon/problem 5 - icon.svg";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-sans font-semibold text-2xl md:text-[40px] leading-snug text-carbon-black relative max-w-[1200px] mx-auto text-center w-full">
          Why Most Dubai Real Estate{" "}
          <span className="sm:whitespace-nowrap">
            Landing Pages{" "}
            <span className="inline-block relative align-middle -mt-2">
              <div className="rotate-[3deg] bg-white border border-racing-red/40 px-3 py-1 rounded-[10px] shadow-[0_8px_15px_-3px_rgba(237,28,36,0.1)] inline-flex items-center justify-center">
                <span className="font-sans font-bold text-2xl md:text-[40px] text-[#ED1C24] leading-none">
                  Burn Budget
                </span>
              </div>
            </span>
