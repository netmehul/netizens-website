    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="font-headings font-normal text-2xl md:text-[30px] leading-snug text-carbon-black relative max-w-[1200px] mx-auto text-center w-full">
                    {heading}
                </h2>
            </div>
            ...
            >
                <div className="flex items-center px-4 py-3 bg-gradient-to-r from-gray-100 to-white border-b border-gray-200 w-full shrink-0">
                    ...
                    <div className="flex-1 text-center">
                        <span className="font-sans font-bold text-xs text-charcoal/70">Notes</span>
                    </div>
