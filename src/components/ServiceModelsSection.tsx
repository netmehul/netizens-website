...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, items, cta, index }) => {
    ...
    return (
        <div
            ref={cardRef}
            className="bg-white rounded-[20px] p-8 shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col h-full hover:shadow-[0_15px_50px_rgba(0,0,0,0.08)] transition-shadow duration-300"
        >
                ...
                {items.map((item, i) => (
                    <div key={i} className="flex items-start gap-3">
                        <div className="mt-1 flex-shrink-0">
                            <img src={iconNavyTick} alt="tick" className="w-4 h-4" />
                        </div>
        ...
        <section className="py-24 px-4 bg-[#FFFAFA] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-headings text-carbon-black mb-6">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-8 md:max-w-5xl mx-auto">
