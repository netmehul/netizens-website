                        ...
                        <div className="col-span-2 row-span-2 bg-white rounded-[10px] p-[34px] flex flex-col gap-[10px] overflow-hidden">
                            <div className="flex flex-col gap-[10px]">
                                <h3 className="font-headings font-normal text-[24px] text-carbon-black leading-normal">
                                    <span className="text-charcoal/40 mr-1">{mainCard.number}.</span> {mainCard.title}
                                </h3>
                                <p className="font-sans font-medium text-sm text-charcoal/75 leading-[22px]">
                        ...
                        >
                            <div className="flex flex-col gap-[10px]">
                                <h3 className="font-headings font-normal text-[18px] text-carbon-black leading-[25px]">
                                    <span className="text-charcoal/40 mr-1">{card.number}.</span> {card.title}
                                </h3>
                                <p className="font-sans font-medium text-sm text-charcoal/75 leading-[22px]">
                                    {card.description}
                                </p>
                ...
                <div className="flex flex-col gap-2 w-full md:hidden">
                    {cards.map((card) => (
                        ...
                        >
                            ...
                            <p className="font-sans font-medium text-[13px] text-charcoal/75 leading-[20px]">
                                {card.description}
                            </p>
