            ...
            <div className="w-full max-w-[1320px] mx-auto px-4 relative z-10 flex flex-col gap-10">
                <div className="flex flex-col items-center justify-center gap-4 text-center">
                    <div className="bg-white/10 border border-[#0E3572]/10 flex items-center justify-center px-4 py-2 rounded">
                        <span className="font-sans text-xs text-snow-white/90">
                            {badge}
                        </span>
                    </div>
                    <h2 className="font-headings font-normal text-3xl md:text-[30px] leading-snug text-snow-white">
                        {heading}
                    </h2>
                </div>
                    ...
                    {cards.map((svc, idx) => (
                        ...
                        >
                            <div className="flex flex-col gap-4 relative z-10">
                                ...
                                <h3 className="font-headings font-normal text-lg md:text-[18px] text-snow-white leading-[25px]">
                                    {svc.title}
                                </h3>
                            </div>
                            <p className="font-sans font-medium text-sm leading-[22px] text-snow-white/75 relative z-10">
                                {svc.description}
                            </p>
                        </div>
                    ))}
                ...
                {footerText && (
                    <p className="font-headings font-normal italic text-center text-snow-white/90 text-base md:text-lg">
                        {footerText}
                    </p>
                )}
            </div>
