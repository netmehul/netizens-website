    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="font-sans font-normal text-2xl md:text-[40px] leading-[48px] tracking-tight text-carbon-black relative max-w-[1200px] mx-auto text-center w-full">
