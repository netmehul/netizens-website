...
import imgModularPage from "../assets/images/bento-section-images/modular-page.svg";
import imgGoogleMeta from "../assets/images/bento-section-images/google meta ad.svg";
import imgHighIntent from "../assets/images/bento-section-images/high-intent lead.svg";
import imgFastLoading from "../assets/images/bento-section-images/fast loading it.svg";
...
export const WhatYouGet = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      textContainerClass: "md:w-1/2 pr-4",
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-8 sm:py-14 md:py-20 bg-[#FDFDFD] overflow-hidden px-4 md:px-8"
    >
      <SidePattern invert />
      ...
      <div className="max-w-[1280px] mx-auto flex flex-col items-center relative z-10 w-full font-['Plus_Jakarta_Sans',sans-serif]">
        ...
        >
          <span className="font-['Plus_Jakarta_Sans'] font-normal text-[12px] text-[#0E3572] bg-[rgba(14,53,114,0.05)] border border-[rgba(14,53,114,0.1)] px-[18px] py-[8px] rounded-[4px] tracking-wide">
            What You Get
          </span>
          <h2 className="font-['Plus_Jakarta_Sans'] font-semibold text-2xl sm:text-[38px] text-[#16181B] leading-tight">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-2 md:gap-4 lg:auto-rows-[auto]">
          {features.map((feature, idx) => (
            ...
            >
              ...
              >
                <h3 className="font-['Sora',sans-serif] font-normal text-[16px] md:text-[18px] text-[#0E3572] leading-tight">
                  {feature.title}
                </h3>
                <p className="font-['Plus_Jakarta_Sans',sans-serif] font-normal text-[14px] text-[rgba(22,24,27,0.7)] leading-[24px]">
                  {feature.subtext}
                </p>
              </div>
