...
export const ComparisonTable = () => {
  return (
    <section className="relative w-full  bg-[#FDFDFD] overflow-hidden px-4 md:px-8 flex flex-col items-center">
      <SidePattern invert />

      <div className="max-w-[1320px] pb-8 sm:pb-14 md:pb-20 mx-auto flex flex-col items-center gap-2 sm:gap-[34px] relative z-10 w-full font-['Plus_Jakarta_Sans',sans-serif]">
        {/* Header title */}
        <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-2xl md:text-[38px] text-[#16181B] text-center leading-tight">
        ...
        <div className="w-full flex flex-col justify-center mt-4 sm:pb-4 pb-12">
          ...
          <div className="w-full flex flex-col drop-shadow-sm rounded-[12px] border border-gray-100">
            {/* Mac Window Header Bar — always full width, never scrolls */}
            <div className="flex items-center px-4 py-3 bg-gradient-to-r from-[rgba(88,89,91,0.05)] to-white border-b border-gray-100 w-full shrink-0 rounded-t-[12px]">
              ...
              <div className="flex-1 text-center font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[12px] text-[rgba(88,89,91,0.75)] tracking-wide uppercase">
                Transparency
              </div>
              <div className="">
                <button>
            ...
            <div className="overflow-x-auto custom-scrollbar">
              <div className="min-w-[700px] sm:min-w-[800px] md:min-w-full">
                ...
                <div className="bg-white rounded-b-[12px] grid grid-cols-4 w-full h-full relative overflow-visible">
                  ...
                  {/* Grid Headings (Row 1)   */}
                  {/* ----------------------- */}
                  <div className="p-2 sm:p-3.5 flex items-center justify-center border-b border-r border-[#EBEBEB] bg-white sticky left-0 z-30 md:static md:z-auto md:shadow-none shadow-[4px_0_12px_-4px_rgba(0,0,0,0.1)]">
                    {/* Empty top-left cell */}
                  </div>
                  <div className="p-2 sm:p-3.5 flex items-center justify-center border-b border-[#EBEBEB] bg-[rgba(14,53,114,0.05)]">
                    <h3 className="font-['Sora',sans-serif] font-semibold text-sm md:text-[19px] text-[#16181B] text-center">
                      Traditional Agency
                    </h3>
                  </div>
                  ...
                  {/* ----------------------- */}
                  <div className="p-2 sm:p-3.5 border-b border-r border-[#EBEBEB] flex items-center bg-white sticky left-0 z-30 md:static md:z-auto md:shadow-none shadow-[4px_0_12px_-4px_rgba(0,0,0,0.1)]">
                  ...
                  <div className="p-2 sm:p-3.5 border-b border-r border-[#EBEBEB] bg-[rgba(14,53,114,0.05)] flex items-center gap-3">
                    <CrossIcon />
                    <p className="font-['Plus_Jakarta_Sans',sans-serif] font-medium text-xs md:text-base text-[#58595B]">
                      Generic templates
                    </p>
                  </div>
                  <div className="p-2 sm:p-3.5 border-b border-r border-[#EBEBEB] bg-[rgba(237,28,36,0.05)] flex items-center gap-3">
                    <CrossIcon />
                    <p className="font-['Plus_Jakarta_Sans',sans-serif] font-medium text-xs md:text-base text-[#58595B]">
                      Design-focused only
                    </p>
                  ...
                  {/* Speed to launch */}
                  {/* ----------------------- */}
                  <div className="p-2 sm:p-3.5 flex items-center border-r border-[#EBEBEB] rounded-bl-[12px] bg-white sticky left-0 z-30 md:static md:z-auto md:shadow-none shadow-[4px_0_12px_-4px_rgba(0,0,0,0.1)]">
                    <p className="font-['Sora',sans-serif] font-normal text-xs md:text-xl text-[#0E3572]">
                      Speed to launch
                    </p>
                  </div>
