            ...
            <div className="w-full max-w-[1320px] mx-auto px-4 flex flex-col lg:flex-row gap-8 lg:gap-16 items-start h-full">
                ...
                >
                    ...
                    <div className="mb-8 md:mb-12 relative z-20">
                        ...
                        <h2 className="font-headings font-normal text-3xl md:text-[38px] leading-snug text-carbon-black max-w-lg">
                ...
                >
                    <div className="bg-regal-navy rounded-xl p-2 md:p-6 flex flex-col gap-8 shadow-2xl">
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="font-headings text-[26px] md:text-[30px] leading-tight text-snow-white">
                                We offer flexible engagement models.
                            </h3>
                            <p className="font-sans font-medium text-sm text-snow-white/75 mt-2">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h4 className="font-sans font-bold text-sm text-snow-white">Fixed Scope</h4>
                                    <p className="font-sans font-medium text-xs text-snow-white/80">Best for clearly defined MVPs</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                <img src={iconLightTick} alt="tick" className="w-6 h-6 mt-0.5 shrink-0" />
                                <div className="flex flex-col gap-1">
                                    <h4 className="font-sans font-bold text-sm text-snow-white">Sprints</h4>
                                    <p className="font-sans font-medium text-xs text-snow-white/80">Ideal for evolving ideas and fast validation</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                <img src={iconLightTick} alt="tick" className="w-6 h-6 mt-0.5 shrink-0" />
                                <div className="flex flex-col gap-1">
                                    <h4 className="font-sans font-bold text-sm text-snow-white">Dedicated Teams</h4>
                                    <p className="font-sans font-medium text-xs text-snow-white/80">Ongoing product development and scale</p>
                                </div>
                            </div>
